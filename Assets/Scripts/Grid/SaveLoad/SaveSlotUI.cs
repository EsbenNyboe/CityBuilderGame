...
public class SaveSlotUI : MonoBehaviour
{
    ...
    public void Initialize(SavedGridStateObject stateObject)
    {
        ...
        _texture2D =
            stateObject.GridSize.x > 0 && stateObject.GridSize.y > 0
                ? new Texture2D(stateObject.GridSize.x, stateObject.GridSize.y)
                : new Texture2D(GridManagerSystem.DefaultWidth, GridManagerSystem.DefaultHeight);
